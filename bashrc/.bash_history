...
cd ~/.dotFiles/
mkdir --help
mkdir terminator/.config/terminator
mkdir -p terminator/.config/terminator
mv ~/.config/terminator/* terminator/.config/terminator/
ls terminator/.config/terminator/
stow terminator
.gitm "added terminator and bashrc"
nvim README.md
